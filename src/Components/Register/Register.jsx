...
const Register = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className="hero min-h-screen bg-base-200 mt-3 bg-no-repeat bg-cover bg-center  rounded-xl" style={{ backgroundImage: 'url(https://blog.flyticket.com.bd/wp-content/uploads/2020/05/image007.jpg)' }}>
